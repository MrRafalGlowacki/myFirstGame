...
if (this.frameX < this.maxFrame) this.frameX++;
      else this.frameX = 0; this.timer = 0;
  ...
  class Layer {
    constructor(game, image, speesModifier) {
      this.game = game;
      this.image = image;
      this.speesModifier = speesModifier;
      this.width = 1768;
      this.height = 500;
      this.x = 0;
      this.y = 0;
    ...
    update() {
      ...
      this.x -= this.game.speed * this.speesModifier;
    }
    draw(context) {
    ...
    draw(context) {
      ...
      if (this.game.gameOver) {
        ...
        if (this.game.score > this.game.winnigScore) {
          message1 = "Not Bad!";
          message2 = "You smashed them all";
        } else {
          message1 = "You've been destroyed!";
          message2 = "what's wrong with You?!";
        }
